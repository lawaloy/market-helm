# MarketHelm documentation

Start with the [main README](../README.md) for install and quick start. Use this index for deeper guides.

| Topic                     | Document                                                                                                                      |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **Install & daily use**   | [USAGE.md](USAGE.md) — CLI entry points, projection backtesting, output files, programmatic API                               |
