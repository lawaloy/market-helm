...
describe('AlertsSettings dual-channel pause discard', () => {
  beforeEach(() => {
  ...
  it('discards an unsaved pause without persisting', async () => {
  ...
  it('allows Send test and Check watches now after discarding a pause', async () => {
    await renderWithWatches();
