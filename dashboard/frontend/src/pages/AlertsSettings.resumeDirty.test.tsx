...
describe('AlertsSettings dual-channel resume dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the resume switch is dirty', async () => {
  ...
  it('auto-saves a dirty resume then runs Check watches now without dropping channels', async () => {
    await renderWithWatches();
