...
describe('AlertsSettings dual-channel pause dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the pause switch is dirty', async () => {
  ...
  it('auto-saves a dirty pause then runs Check watches now without dropping channels', async () => {
    await renderWithWatches();
