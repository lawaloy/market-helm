...
describe('AlertsSettings dual-channel threshold dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the tightened threshold is dirty', async () => {
  ...
  it('auto-saves a dirty threshold then runs Check watches now without dropping channels', async () => {
    await renderWithWatches();
