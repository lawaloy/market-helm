...
describe('AlertsSettings dual-channel operator dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the flipped operator is dirty', async () => {
  ...
  it('auto-saves a dirty operator then runs Check watches now without dropping channels', async () => {
    await renderWithWatches();
