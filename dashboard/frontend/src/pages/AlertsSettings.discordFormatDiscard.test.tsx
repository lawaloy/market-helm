...
describe('AlertsSettings dual-channel Discord chip discard from Slack', () => {
  beforeEach(() => {
  ...
  it('discards an unsaved Discord chip back to Slack without persisting', async () => {
  ...
  it('allows Send test and Check watches now after discarding Discord without saving', async () => {
    await renderWithWatches();
