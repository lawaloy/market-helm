...
describe('AlertsSettings dual-channel webhook draft dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the webhook URL draft is dirty', async () => {
  ...
  it('auto-saves a dirty webhook URL then runs Check watches now', async () => {
    await renderWithWatches();
