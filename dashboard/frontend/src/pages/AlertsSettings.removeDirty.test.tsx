...
describe('AlertsSettings dual-channel remove dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test on the remaining watch while a remove is dirty', async () => {
  ...
  it('auto-saves a dirty remove then runs Check watches now without dropping the sibling', async () => {
    await renderWithWatches();
