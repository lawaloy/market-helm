...
describe('AlertsSettings dual-channel Slack format dirty guards', () => {
  beforeEach(() => {
  ...
  it('refuses Send test while the Slack format chip is dirty', async () => {
  ...
  it('auto-saves a dirty Slack format then runs Check watches now without rewriting the webhook URL', async () => {
    await renderWithWatches();
