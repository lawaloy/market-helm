...
describe('AlertsSettings dual-channel resume persist', () => {
  beforeEach(() => {
    ...
    apiMocks.testAlert.mockResolvedValue({
      data: { alert_id: pausedDualChannelRule.id, status: 'ok', notifiers: ['email', 'webhook'] },
    });
  ...
  it('re-enables a paused dual-channel watch without dropping email or Discord', async () => {
